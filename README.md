...
**臨床工学技士(CE:Clinical Engineer) → Webエンジニア｜臨床経験をもとに医療現場の課題をITで解決したい**
...
- [2021 - ]某地方内視鏡技師会 役員
- [2025 - ]某医療系専門学校 臨床検査学科 内視鏡総論 非常勤講師
...
- 医療現場の紙運用をデジタル化し、**現在も実業務で稼働中**
- AIバイブコーディングで構築後、セキュリティ・品質面を体系的にリファクタリング
- Nuxt3 / Vue3 / Vuetify3 / PostgreSQL / TypeScript
...
技術的な学びや開発の振り返りをZennに投稿しています。

[![Zenn](https://img.shields.io/badge/Zenn-3EA8FF?style=flat-square&logo=zenn&logoColor=white)](https://zenn.dev/sho_ce_engineer)

---

## 📫 Contact

[![Website](https://img.shields.io/badge/Website-coils--net.net-000000?style=flat-square)](https://coils-net.net/)
